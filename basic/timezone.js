...
const timeZoneOffset = date_fns_tz.getTimezoneOffset('-07:30');
console.log(timeZoneOffset / 1000 / 60 / 60);
...
let now = new Date();
console.log(now.toUTCString(), 21);
console.log(now.toISOString(), 22);

let utcDate = date_fns_tz.zonedTimeToUtc(now, '08:00');
let dateStr = utcDate.toString();
console.log(dateStr, 25);

let utc_date = date_fns_tz.utcToZonedTime(utcDate, '08:00');
console.log(utc_date, 28);
// let timeZoneDate = add(utc_date, {
// 	years: 0,
// 	months: 0,
// 	weeks: 0,
// 	days: 0,
...
// +8
// ["Monday|02:22-08:00","Sunday|02:22-08:00"]

var arrayIannaTimeZones = [
	'Europe/Andorra',
	'Asia/Dubai',
	'Asia/Kabul',
	'Europe/Tirane',
...
// arrayIannaTimeZones.forEach(t => console.log(t, date_fns_tz.getTimezoneOffset(t) / 1000 / 60 / 60));

// console.log(arrayIannaTimeZones.length);

let arrTimeZoneOffsets = [];

for (let index = -12; index < 15; index++) {
	let element = '';
	if(Math.abs(index) < 10) {
		element = `${index < 0 ? '-' : '+'}0${Math.abs(index)}:00`;
	} else {
